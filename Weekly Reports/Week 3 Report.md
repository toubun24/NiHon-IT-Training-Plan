...
46. [React/Redux/React-Native snippets](https://www.cnblogs.com/wanglei1900/p/17556994.html)
...
2. `06_03_props.html`中，拓展运算符不知道为什么无法在控制台进行输出
  ```JavaScript
...
3. 复现TodoList时，Item/index.css中对button采用`float: right;`向右浮动样式则会使其跑到该行的最右上；结合`margin-top: 6px;`才使其回到垂直居中状态，但不知道有没有能直接达成精准的垂直居中又向右对齐(无需浮动)的操作[参考链接](https://www.python100.com/html/0J5BP6XD7J48.html)

## 下周计划

* 这周除了背单词外，尝试了影子跟读，效果还可以，后面也将加入每日计划中