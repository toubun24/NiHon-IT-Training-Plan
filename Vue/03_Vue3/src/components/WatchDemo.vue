...
export default {
  ...
  setup() {
    ...
    //   // 相比于情况三中console.log(nv, ov);输出结果均为nv，此处可以正常输出nv和ov
    // });
    ...
    watch(() => person.job, (nv, ov) => {
      ...
      // Proxy(Object) {j1: {…}} Proxy(Object) {j1: {…}} 
      console.log('person的job信息发生改变了',nv.j1, ov.j1);
      // Proxy(Object) {salary: 21} Proxy(Object) {salary: 21}
      console.log('person的job信息发生改变了',nv.j1.salary, ov.j1.salary);
      // 21 21
    }, {
      //这里必须要加deep:true注意
